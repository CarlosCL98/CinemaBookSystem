...
public class InMemoryCinemaPersistence implements CinemaPersitence {
	...
	public List<CinemaFunction> getFunctionsbyCinemaAndDate(String cinema, String date) throws CinemaPersistenceException {
		...
		if(funcionesCinemaDate.isEmpty()) throw new CinemaPersistenceException("No existen funciones para el cine " + cinema + " en la fecha " + date);
	...
	public CinemaFunction getFunctionbyCinemaDateAndMovie(String cinema, String date, String movie) throws CinemaPersistenceException {
		...
		if(funcion == null) throw new CinemaPersistenceException("No existe alguna funcion en el cine " + cinema + " en la fecha " + date + " que presente la película: "+movie);
		return funcion;
	}
